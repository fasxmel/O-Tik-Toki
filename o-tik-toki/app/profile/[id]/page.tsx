...
const Profile = ({ params }: ProfilePageTypes) => {
    ...
    const currentProfile = {
        ...
        bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel lobortis tortor, ac ullamcorper neque. Nulla facilisi. Vestibulum vel consequat lectus. Sed id ligula vel libero commodo pulvinar. Aenean non risus vel justo condimentum fermentum.',
    }
    return (
        <>
            <MainLayout>
